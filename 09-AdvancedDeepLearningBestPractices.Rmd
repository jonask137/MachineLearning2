...
```{r fig76,echo=FALSE,fig.cap="A model with several inputs"}
...
```{r ,echo=FALSE,fig.cap="A model with several outputs"}
...
```{r,echo=FALSE,fig.cap="A model with several inputs"}
